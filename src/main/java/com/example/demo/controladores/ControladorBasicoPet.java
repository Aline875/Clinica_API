...
@RestController
@RequestMapping("controladorbasicopet") // Altere o mapeamento aqui para ser exclusivo
public class ControladorBasicoPet {
    @Autowired
    ...
    @GetMapping("/get/{id}") // Remova "controladorbasico" do mapeamento aqui
